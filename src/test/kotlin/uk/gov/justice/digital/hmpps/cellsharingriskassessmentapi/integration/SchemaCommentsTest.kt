...
/**
 * Guards the data dictionary published to GitHub Pages (see db/migration/V14__schema_comments.sql).
 *
...
class SchemaCommentsTest : IntegrationTestBase() {
  ...
  fun `every column description carries a sensitivity classification`() {
    ...
    assertThat(misclassified)
      .describedAs("column comments must end with one of $SENSITIVITY - see V14__schema_comments.sql")
      .isEmpty()
  }
